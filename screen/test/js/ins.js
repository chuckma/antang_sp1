var Fireworks = function () {
    ...
    while (initialLaunchCount--) {
        console.log(initialLaunchCount)
        setTimeout(function () {
            // self.fireworks.push(new Firework(self.cw/2, self.ch, rand(50, self.cw-50), rand(50, self.ch/2)-50));
            self.fireworks.push(new Firework(100, 150, 280, 250));
            self.fireworks.push(new Firework(100, 180, 280, 250));
            self.fireworks.push(new Firework(100, 220, 280, 250));
            self.fireworks.push(new Firework(100, 300, 280, 250));

        }, initialLaunchCount * 1000);
    }
